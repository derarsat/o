...
@section("content")
    ...
    <form action="{{route('events.update',$event->id)}}" method="post" class="grid grid-cols-2 gap-12"
        ...
        <div>
            ...
            <div class="input-group">
                ...
                <input value="{{$event->title}}" type="text" id="title" placeholder="Enter event name" required
                       name="title">
                @error('title')
            ...
            <div class="input-group">
                ...
                <textarea id="desc" placeholder="Enter event description" required name="desc">
                {{$event->desc}}
                </textarea>
                @error('desc')
                <span class="error-label" role="alert">
            ...
            <div class="grid grid-cols-2 w-full input-group flex-col">
                <div class="">
                ...
                <img class=" block mx-auto w-32 mt-9 full rounded-md"
                     src="{{ @App::make('url')->to('/').'/storage'.$event->image }}" alt="">
                @error('image')
                <span class="error-label" role="alert">
            <strong>{{ $message }}</strong>
        </span>
        ...
        <div>
            ...
            <div class="input-group">
                ...
                <textarea id="hint" placeholder="Enter event hint" required name="hint">
                {{$event->hint}}
                </textarea>
                @error('hint')
                <span class="error-label" role="alert">
            ...
            <div class="input-group">
                ...
                <input value="{{$event->date}}" type="datetime-local" id="date" placeholder="Enter event date" required
                       name="date">
                @error('date')
                <span class="error-label" role="alert">
                    <strong>{{ $message }}</strong>
